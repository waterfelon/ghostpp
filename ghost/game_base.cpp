...
void CBaseGame :: StartCountDownAuto( bool requireSpoofChecks )
{
	if( !m_CountDownStarted )
	{
		...
		{
			m_AmountOfTimedSkippedAutoStartMessage = m_AmountOfTimedSkippedAutoStartMessage + 1;
			if (m_AmountOfTimedSkippedAutoStartMessage > 6) {
				...
				m_AmountOfTimedSkippedAutoStartMessage = 0;
			}
